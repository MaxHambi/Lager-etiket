...
| ADR | Entscheidung |
|---|---|
| [ADR-0001](decisions/ADR-0001-etiket-ersetzt-jsbarcode.md) | etiket ersetzt JsBarcode als Barcode-Renderer (eine Bibliothek für beide Pipelines) |
| [ADR-0002](decisions/ADR-0002-renderdpi-und-rasterungsabweichung.md) | `output.renderDpi` als gemeinsamer Rasterungs-Parameter; akzeptierte Browser/CLI-Größendifferenz (librsvg-72-dpi-Quirk) |
| [ADR-0003](decisions/ADR-0003-eingabegate-validateEntry.md) | Eingabegate (`validateEntry`) in UI + CLI, damit ungültige Codes vor dem Rendern abgelehnt werden |
| [ADR-0004](decisions/ADR-0004-zentrale-fehlertaxonomie.md) | Zentrale Fehlertaxonomie (`AppError`, etiket-Fehler-Integration, `describeError()`-Mapper) |
