...
| 8   | **Persistenz nach Reload**: Theme, Zielbereich-Overlay, Zielbereich automatisch, zuletzt gewählte Vorlage                                                                                                                    | ✅       | localStorage: `lager-etiket-show-area=1`, `lager-etiket-theme=catppuccin-macchiato`, `lager-etiket-last-template=MV.png`; nach Reload: Overlay angehakt, Theme aktiv, Galerie-Karte „MV" wieder ausgewählt                                                                                                                                           |
|     |                                                                                                                                                                                                                              |          | **Hinweis (Korrektur, Issue #23):** Beim Original-Test war nur `showArea` (Overlay) eingeschlossen — `areaAuto` (Zielbereich automatisch) war **nicht** Teil des Durchlaufs und wurde erst später (Issue #23) persistierbar. Einzelnachweis jetzt: vitest-Test `packages/web/test/persistence.test.ts` und erweiterter Playwright-Smoke (Schritt 7). |
