...
import { EtiketError } from "./errors.ts";
import { appErrors } from "./errors.ts";
...
export function renderBarcodeImage(
  ...
  return new Promise<HTMLImageElement>((resolve, reject) => {
    ...
    img.onerror = (): void => reject(appErrors.renderFailed("SVG konnte nicht in ein Bild geladen werden"));
    img.src = svgBase64;
  });
}
