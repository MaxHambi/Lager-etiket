/**
 * Stellt sicher, dass apps/web/src/generated/vault.ts existiert (Entwicklungs-Stub),
 ...
 * Läuft aus dem Repo-Root ODER aus apps/web (cwd-unabhängig).
 */
...
if (!existsSync(vaultFile)) {
  ...
  console.log("[vault-stub] apps/web/src/generated/vault.ts (Stub) erzeugt.");
} else {
  console.log("[vault-stub] apps/web/src/generated/vault.ts bereits vorhanden — unverändert.");
}
